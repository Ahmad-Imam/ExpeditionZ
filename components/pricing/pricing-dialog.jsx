...
export const PricingDialog = ({
  ...
  return (
    (<Dialog open={open} onOpenChange={setOpen}>
      <DialogContent
        className={cn(className, "p-0 rounded-lg text-foreground gap-0 text-sm shadow-inner")}>
        {children}
      </DialogContent>
    </Dialog>)
  );
...
export const Information = ({
  ...
  return (
    (<div
      className={cn(className, "text-foreground px-6 pb-3 text-sm whitespace-pre-line")}>
      {children}
    </div>)
  );
};
...
export const QuantityInput = ({
  ...
  return (
    (<div className={cn(className, "flex flex-row items-center gap-4")} {...props}>
...
export const TotalPrice = ({
  ...
  return (
    (<div
      className="px-2 w-full mb-4 sm:mb-0 font-semibold flex justify-between items-center">
      {children}
    </div>)
  );
};

export const PricingDialogButton = React.forwardRef(({ children, onClick, className, ...props }, ref) => {
  return (
    (<Button
      onClick={onClick}
      {...props}
